class ApplicationController < ActionController::Base
  ...
  def buscar
    ...
    if(!params.key?("tag") or !params.key?("access_token"))
      ...
      @tags_count = HTTParty.get('https://api.instagram.com/v1/tags/' + params["tag"]+ '?access_token=' + params["access_token"])["data"]["media_count"]
      ...
      if(@tags != nil)
        ...
        render status: 200, json: JSON.pretty_generate({metadata: {total: @tags_count}, posts: @new_tags, version: "0.2.0"})
      else
